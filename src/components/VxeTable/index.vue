<template>
    <div>
      <vxe-table
        ...
        <vxe-column field="role" title="替换后 - 文件名称" :edit-render="{}">
          <template #edit="{ row }">
            <vxe-input v-model="row.role" type="text" placeholder="请输入昵称"></vxe-input>
          </template>
        </vxe-column>
        <vxe-column field="sex" title="口味英文" :edit-render="{}">
        ...
        <vxe-column field="sex2" title="产品参数" :edit-render="{}">
          <template #default="{ row }">
